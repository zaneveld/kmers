...
#NOTE: Dr. Brown has the input genomes
#We might want to reverse engineer an NCBI Datasets command to download them 
#automatically in the first step.
